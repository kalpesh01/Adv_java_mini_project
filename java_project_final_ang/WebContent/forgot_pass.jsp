...
<div class="container-fluid d-flex justify-content-center" style="height: 100vh ;background-image: url('stadium2.jpg');
 ...
 ">
	<div style="width: 50%">
	<spr:form action="forgetpass.htm" method="post" commandName="user" >
	...
	<thead class="text-light">
		...
		<tr>
			<td><h4 style="color:black;font-size: medium;font-weight: bold;" class="btn btn danger" >Email Id :</h4>
				
			</td>
			<td>
				<spr:input class="form-control" path="emailId"/>
			</td>
			<spr:errors style="color:red" path="emailId" ></spr:errors>
		</tr>
		<tr>
			<td><h4 style="color:black;font-size: medium;font-weight: bold;" class="btn btn danger" >Password :</h4>
			</td>
			<td>
				<spr:password class="form-control" path="userPass"/>
			</td>
			<spr:errors style="color:red" path="userPass" ></spr:errors>
		</tr>
